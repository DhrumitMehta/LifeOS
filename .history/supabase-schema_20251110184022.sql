...
CREATE TABLE IF NOT EXISTS investments (
    id TEXT PRIMARY KEY,
    name TEXT NOT NULL,
    type TEXT NOT NULL CHECK (type IN ('stock', 'bond', 'crypto', 'mutual-fund', 'real-estate')),
    symbol TEXT,
...
CREATE TABLE IF NOT EXISTS subscriptions (
    ...
    name TEXT NOT NULL,
    amount DECIMAL(10,2) NOT NULL,
    recurring_date INTEGER NOT NULL CHECK (recurring_date >= 1 AND recurring_date <= 31),
