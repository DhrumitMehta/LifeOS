  ...
  const renderOverview = () => (
    ...
    >
      <Card style={styles.goalsCard}>
        <Card.Content>
          <Title>Current Financial Goals</Title>
          <View style={styles.goalsList}>
            <View style={styles.goalItem}>
              <Text style={styles.goalNumber}>1.</Text>
              <Text style={styles.goalText}>Be independent - not take a single penny from my parents</Text>
            </View>
            <View style={styles.goalItem}>
              <Text style={styles.goalNumber}>2.</Text>
              <Text style={styles.goalText}>Save for future while still enjoying the present</Text>
            </View>
          </View>
        </Card.Content>
      </Card>
