    ...
    >
      <View style={styles.summaryCards}>
        ...
        <Card style={[styles.summaryCard, { backgroundColor: '#3b82f6' }]}>
          <Card.Content>
            <Title style={styles.summaryTitle}>Investments</Title>
            <Text style={styles.summaryAmount}>{formatCurrency(getTotalInvestments())}</Text>
          </Card.Content>
        </Card>

        <Card style={[styles.summaryCard, { backgroundColor: '#8b5cf6' }]}>
          <Card.Content>
            <Title style={styles.summaryTitle}>Net Worth</Title>
