  ...
  const renderOverview = () => (
    ...
    >
      <View style={styles.summaryCards}>
        ...
        <Card style={[styles.summaryCard, { backgroundColor: '#60a5fa' }]}>
          <Card.Content>
        ...
        <Card style={[styles.summaryCard, { backgroundColor: '#818cf8' }]}>
          <Card.Content>
            <Title style={styles.summaryTitle}>NMB Virtual Card</Title>
