...
const FinanceScreen = () => {
  ...
  const getCashBalance = () => {
    // Cash balance = Total income - Total expenses (excluding investments which are assets)
    return getTotalIncome() - getTotalExpenses();
  };

  const getNetWorth = () => {
    // Net worth = Cash balance + Investment values
    return getCashBalance() + getTotalInvestments();
  };
