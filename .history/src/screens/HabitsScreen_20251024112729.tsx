...
const HabitsScreen = () => {
  ...
  const { state, addHabit, deleteHabit, addHabitEntry, deleteHabitEntry } = useApp();
    ...
    try {
      ...
      if (entryToDelete) {
        ...
        dispatch({ 
          ...
          payload: { ...entryToDelete, completed: false } 
        });
        
        // For now, we'll just mark as incomplete in local state
        // In a real app, you'd want to delete from database or update the entry
