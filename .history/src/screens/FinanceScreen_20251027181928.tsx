...
const FinanceScreen = () => {
  ...
  const getBankBalance = () => {
    const bankTransactions = state.transactions.filter(t => 
      t.account?.toLowerCase().includes('bank')
    );
  ...
  const getMobileBalance = () => {
    const mobileTransactions = state.transactions.filter(t => 
      t.account?.toLowerCase().includes('mobile')
    );
