...
const FinanceScreen = () => {
  ...
  // Calculate balances from transactions in chronological order
  const getCashBalance = () => {
    const cashTransactions = state.transactions
      .filter(t => t.account === 'Cash' && t.account !== 'Inv')
  ...
  const getBankBalance = () => {
    const bankTransactions = state.transactions
      .filter(t => t.account === 'Bank' && t.account !== 'Inv')
      .sort((a, b) => a.date.getTime() - b.date.getTime());
  ...
  const getMobileBalance = () => {
    const mobileTransactions = state.transactions
      .filter(t => t.account === 'Mobile' && t.account !== 'Inv')
      .sort((a, b) => a.date.getTime() - b.date.getTime());
