                ...
                anchor={
                  <Button 
                    ...
                    onPress={() => {
                      ...
                      setShowBooleanMenu(!showBooleanMenu);
                    }}
                  ...
                  anchor={
                    <Button 
                      ...
                      onPress={() => {
                        ...
                        setShowNumericMenu(!showNumericMenu);
                      }}
                      style={styles.chartSelector}
                    >
                ...
                anchor={
                  <Button 
                    ...
                    onPress={() => {
                      ...
                      setShowNumericMenu2(!showNumericMenu2);
                    }}
                    style={styles.chartSelector}
                  >
...
const styles = StyleSheet.create({
  ...
  // Numeric time chart styles (scrollable)
  numericTimeChart: {
    height: 200,
    minWidth: 600, // Ensure minimum width for scrolling
  },
  numericTimeChartContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'flex-end',
    height: 150,
    paddingHorizontal: 8,
    minWidth: 600, // Allow horizontal scrolling
  },
  numericTimeChartItem: {
    flex: 1,
    alignItems: 'center',
    marginHorizontal: 2,
    minWidth: 40, // Minimum width per item
  },
  numericTimeChartBar: {
    width: 25,
    height: 120,
  ...
  numericTimeChartFill: {
    width: '100%',
    borderRadius: 2,
    minHeight: 2,
  },
  numericTimeChartLabel: {
    fontSize: 8,
    color: '#6b7280',
    textAlign: 'center',
    marginBottom: 2,
  },
  numericTimeChartValue: {
    fontSize: 8,
    fontWeight: 'bold',
    color: '#374151',
    textAlign: 'center',
  },
  numericTimeChartAxis: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingHorizontal: 8,
  },
