...
const AnalyticsScreen = () => {
  ...
  console.log('Boolean habits:', booleanHabits.length);
  console.log('Numeric habits:', numericHabits.length);
  console.log('All habits:', state.habits.length);
  ...
  const renderBooleanChart = (habit: Habit) => {
    console.log('Rendering boolean chart for habit:', habit.name);
    const data = getBooleanChartData(habit);
    console.log('Boolean chart data:', data);
    ...
    >
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Text>Total habits: {state.habits.length}</Text>
          <Text>Boolean habits: {booleanHabits.length}</Text>
          <Text>Numeric habits: {numericHabits.length}</Text>
          <Text>Habit entries: {state.habitEntries.length}</Text>
        </Card.Content>
      </Card>
      
      {/* Chart 1: Boolean Habit Completion by Day of Week */}
      {(booleanHabits.length > 0 || state.habits.length > 0) && (
        <Card style={styles.card}>
          <Card.Content>
      ...
      {(numericHabits.length > 0 || state.habits.length > 0) && (
        <Card style={styles.card}>
          <Card.Content>
            <View style={styles.chartHeader}>
