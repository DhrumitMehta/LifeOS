...
import balanceConfig from '../config/balances.json';
...
const FinanceScreen = () => {
  ...
  // Use balances from Excel (most accurate - calculated from running balance columns)
  const getCashBalance = () => balanceConfig.cashBalance;
  const getBankBalance = () => balanceConfig.bankBalance;
  const getMobileBalance = () => balanceConfig.mobileBalance;
