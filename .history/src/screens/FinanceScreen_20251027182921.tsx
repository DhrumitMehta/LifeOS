...
const FinanceScreen = () => {
  ...
  const getCashBalance = () => {
    // Find the last transaction for cash account that has a balance
    const cashTransactions = state.transactions
      .filter(t => t.account === 'Cash')
      .sort((a, b) => b.date.getTime() - a.date.getTime());
    
    // Start from the earliest transaction and calculate running balance
    const sortedTransactions = [...cashTransactions].sort((a, b) => a.date.getTime() - b.date.getTime());
    let balance = 0;
