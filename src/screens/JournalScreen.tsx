...
// Header button component to avoid state issues
const HeaderViewToggle = ({ viewMode, onViewModeChange }: { 
  viewMode: 'list' | 'grid', 
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Ionicons name="list" size={20} color="#374151" style={{ marginRight: 12 }} />
              <Text style={{ color: '#374151', fontSize: 16 }}>List View</Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Ionicons name="grid" size={20} color="#374151" style={{ marginRight: 12 }} />
              <Text style={{ color: '#374151', fontSize: 16 }}>Grid View</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
...
const JournalScreen = () => {
  ...
  const filteredEntries = useMemo(() => {
    ...
    // Only apply search filters in list view
    if (viewMode === 'list') {
  ...
  }, [state.journalEntries, searchQuery, searchFilters, viewMode]);
