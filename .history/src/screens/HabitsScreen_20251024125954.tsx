...
const HabitsScreen = () => {
  ...
  const getMonthDays = (month: Date) => {
    ...
    lastSunday.setDate(lastDay.getDate() + sundayOffset);
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerControls}>
          <Button
            mode={isMonthView ? "contained" : "outlined"}
            onPress={() => setIsMonthView(!isMonthView)}
            style={styles.viewToggle}
            icon={isMonthView ? "calendar-month" : "calendar-week"}
          >
      ...
      >
        <View style={styles.gridContainer}>
          {renderGridHeader()}
          {isMonthView ? 
            getMonthWeeks(selectedMonth).map((week, weekIndex) => (
